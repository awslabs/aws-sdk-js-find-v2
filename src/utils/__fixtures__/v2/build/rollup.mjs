import require$$3$2 from 'util';
import require$$1$1 from 'fs';
import require$$0 from 'crypto';
import require$$3$5 from 'buffer';
import require$$4$2 from 'domain';
import require$$1$2 from 'stream';
import require$$3$4 from 'url';
import require$$7 from 'querystring';
import require$$1$3 from 'dgram';
...
import require$$1$7 from 'events';
...
var hasRequiredEscapeAttribute;

function requireEscapeAttribute () {
	if (hasRequiredEscapeAttribute) return escapeAttribute_1;
	hasRequiredEscapeAttribute = 1;
...
function requireXmlNode () {
	...
	var escapeAttribute = requireEscapeAttribute().escapeAttribute;
...
var escapeElement_1;
var hasRequiredEscapeElement;

function requireEscapeElement () {
	if (hasRequiredEscapeElement) return escapeElement_1;
	hasRequiredEscapeElement = 1;
...
function requireXmlText () {
	if (hasRequiredXmlText) return xmlText;
	hasRequiredXmlText = 1;
	var escapeElement = requireEscapeElement().escapeElement;
...
function requireBuilder$1 () {
	...
	var util = requireUtil();
	var XmlNode = requireXmlNode().XmlNode;
	var XmlText = requireXmlText().XmlText;
...
var api_loader;
var hasRequiredApi_loader;

function requireApi_loader () {
	if (hasRequiredApi_loader) return api_loader;
	hasRequiredApi_loader = 1;
	  ...
	  Logger: new SequentialExecutor().addNamedListeners(function(add) {
	    add('LOG_REQUEST', 'complete', function LOG_REQUEST(resp) {
	      ...
	      function buildMessage() {
	        ...
	        var params = require$$3$2.inspect(censoredParams, true, null);
	        var message = '';
...
var hasRequiredJmespath;

function requireJmespath () {
	if (hasRequiredJmespath) return jmespath;
	hasRequiredJmespath = 1;
	(function (exports$1) {
		(function(exports$1) {
...
var maintenance_mode_message = {exports: {}};

var hasRequiredMaintenance_mode_message;

function requireMaintenance_mode_message () {
	if (hasRequiredMaintenance_mode_message) return maintenance_mode_message.exports;
	hasRequiredMaintenance_mode_message = 1;
	(function (module) {
		var warning = [
	...
	return maintenance_mode_message.exports;
}
...
function requireCore () {
	...
	requireMaintenance_mode_message();
...
function requireV1 () {
	...
	var _bytesToUuid = _interopRequireDefault(/*@__PURE__*/ requireBytesToUuid());
...
function requireUtil () {
	...
	var util = {
	  ...
	  readFileSync: function readFileSync(path) {
	    ...
	    return require$$1$1.readFileSync(path, 'utf-8');
	  },
	  ...
	  string: {
	    byteLength: function byteLength(string) {
	      ...
	      if (typeof string.byteLength === 'number') {
	        ...
	        return require$$1$1.lstatSync(string.path).size;
	      } else {
	  ...
	  uuid: {
	    v4: function uuidV4() {
	      return /*@__PURE__*/ requireDist().v4();
	    }
	  },
...
function requireInt64 () {
	...
	Int64.fromNumber = function(number) {
	    if (number > 9223372036854775807 || number < -9223372036854776e3) {
	        throw new Error(
...
var nodeClock;
var hasRequiredNodeClock;

function requireNodeClock () {
	if (hasRequiredNodeClock) return nodeClock;
	hasRequiredNodeClock = 1;
	nodeClock = {
...
function requirePublisher () {
	if (hasRequiredPublisher) return publisher;
	hasRequiredPublisher = 1;
	var util = requireCore().util;
	var dgram = require$$1$3;
...
function requireConfiguration () {
	...
	configuration = resolveMonitoringConfig;
...
var hasRequiredSharedIni;

function requireSharedIni () {
	if (hasRequiredSharedIni) return sharedIni;
	hasRequiredSharedIni = 1;
...
function requireCognitoidentity () {
	...
	Object.defineProperty(apiLoader.services['cognitoidentity'], '2014-06-30', {
	  get: function get() {
	    var model = require$$2;
	    model.paginators = require$$3$1.pagination;
	    return model;
	  },
	  enumerable: true,
	  configurable: true
...
function requireNode () {
	...
	AWS.NodeHttpClient = AWS.util.inherit({
	  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
	    ...
	    var http = useSSL ? require$$2$3 : require$$3$3;
	    var options = {
...
function requireNode_loader () {
	...
	util.crypto.lib = require$$0;
	util.Buffer = require$$3$5.Buffer;
	util.domain = require$$4$2;
	util.stream = require$$1$2;
	util.url = require$$3$4;
	util.querystring = require$$7;
	...
	util.realClock = requireNodeClock();
	util.clientSideMonitoring = {
	  Publisher: requirePublisher().Publisher,
	  configProvider: requireConfiguration(),
	};
	util.iniLoader = requireSharedIni().iniLoader;
	util.getSystemErrorName = require$$3$2.getSystemErrorName;
...
var config_regional_endpoint;
var hasRequiredConfig_regional_endpoint;

function requireConfig_regional_endpoint () {
	if (hasRequiredConfig_regional_endpoint) return config_regional_endpoint;
	hasRequiredConfig_regional_endpoint = 1;
	var AWS = requireCore();
	/**
	 * @api private
	 */
	...
	function resolveRegionalEndpointsFlag(originalConfig, options) {
	  ...
	  } catch (e) {}	  if (profile && Object.prototype.hasOwnProperty.call(profile, options.sharedConfig)) {
	...
	config_regional_endpoint = resolveRegionalEndpointsFlag;
	return config_regional_endpoint;
}

var hasRequiredSts$1;

function requireSts$1 () {
	if (hasRequiredSts$1) return sts$1;
	hasRequiredSts$1 = 1;
	var AWS = requireCore();
	var resolveRegionalEndpointsFlag = requireConfig_regional_endpoint();
...
var stsExports = requireSts();
var STS = /*@__PURE__*/getDefaultExportFromCjs(stsExports);
