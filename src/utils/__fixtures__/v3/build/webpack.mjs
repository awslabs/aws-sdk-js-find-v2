...
var getSchemaSerdePlugin = __webpack_require__(4564);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(AccessDeniedException$, AccessDeniedException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(AuthorizationPendingException$, AuthorizationPendingException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(ExpiredTokenException$, ExpiredTokenException);
var InternalServerException$ = [-3, n0, _ISE, { [_e]: _se, [_hE]: 500 }, [_e, _ed], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InternalServerException$, InternalServerException);
var InvalidClientException$ = [-3, n0, _ICE, { [_e]: _c, [_hE]: 401 }, [_e, _ed], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidClientException$, InvalidClientException);
var InvalidGrantException$ = [-3, n0, _IGE, { [_e]: _c, [_hE]: 400 }, [_e, _ed], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidGrantException$, InvalidGrantException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidRequestException$, InvalidRequestException);
var InvalidScopeException$ = [-3, n0, _ISEn, { [_e]: _c, [_hE]: 400 }, [_e, _ed], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidScopeException$, InvalidScopeException);
var SlowDownException$ = [-3, n0, _SDE, { [_e]: _c, [_hE]: 400 }, [_e, _ed], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(SlowDownException$, SlowDownException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(UnauthorizedClientException$, UnauthorizedClientException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(UnsupportedGrantTypeException$, UnsupportedGrantTypeException);
var SSOOIDCServiceException$ = [-3, _sm, "SSOOIDCServiceException", 0, [], []];
TypeRegistry/* TypeRegistry */.O.for(_sm).registerError(SSOOIDCServiceException$, SSOOIDCServiceException);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 909));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 909));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ deserializingStructIterator),
/* harmony export */   R: () => (/* binding */ serializingStructIterator)
/* harmony export */ });
...
function* serializingStructIterator(ns, sourceObject) {
    ...
    for (let i = 0; i < struct[4].length; ++i) {
        ...
        const memberNs = new _smithy_core_schema__WEBPACK_IMPORTED_MODULE_0__/* .NormalizedSchema */ .l([memberSchema, 0], key);
...
module.exports = __WEBPACK_EXTERNAL_createRequire_require("fs/promises");
...
var CredentialsProviderError = __webpack_require__(3052);
;// external "url"
const external_url_namespaceObject = __WEBPACK_EXTERNAL_createRequire_require("url");
// EXTERNAL MODULE: ./node_modules/@smithy/property-provider/dist-es/ProviderError.js
var ProviderError = __webpack_require__(6014);
...
class ProtocolLib {
    ...
    async getErrorSchemaOrThrowBaseException(errorIdentifier, defaultNamespace, response, dataObject, metadata, getErrorSchema) {
        ...
        const registry = _smithy_core_schema__WEBPACK_IMPORTED_MODULE_1__/* .TypeRegistry */ .O.for(namespace);
        try {
            ...
            const synthetic = _smithy_core_schema__WEBPACK_IMPORTED_MODULE_1__/* .TypeRegistry */ .O.for("smithy.ts.sdk.synthetic." + namespace);
    ...
    findQueryCompatibleError(registry, errorName) {
        try {
            ...
            return registry.find((schema) => _smithy_core_schema__WEBPACK_IMPORTED_MODULE_0__/* .NormalizedSchema */ .l.of(schema).getMergedTraits().awsQueryError?.[0] === errorName);
        }
    }
}
...
function schemaLogFilter(schema, data) {
    ...
    const ns = NormalizedSchema/* NormalizedSchema */.l.of(schema);
...
class FromStringShapeDeserializer extends SerdeContext/* SerdeContext */.f {
    ...
    read(_schema, data) {
        const ns = NormalizedSchema/* NormalizedSchema */.l.of(_schema);
        if (ns.isListSchema()) {
...
class RpcProtocol extends HttpProtocol/* HttpProtocol */.t {
    ...
    async deserializeResponse(operationSchema, context, response) {
        ...
        const ns = NormalizedSchema/* NormalizedSchema */.l.of(operationSchema.output);
        const dataObject = {};
...
class AwsQueryProtocol extends RpcProtocol {
    ...
    async handleError(operationSchema, context, response, dataObject, metadata) {
        ...
        const ns = NormalizedSchema/* NormalizedSchema */.l.of(errorSchema);
        const ErrorCtor = TypeRegistry/* TypeRegistry */.O.for(errorSchema[1]).getErrorCtor(errorSchema) ?? Error;
...
;// external "util"
const external_util_namespaceObject = __WEBPACK_EXTERNAL_createRequire_require("util");
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/client/setCredentialFeature.js
var setCredentialFeature = __webpack_require__(244);
...
/* harmony import */ var _smithy_protocol_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7324);
/* harmony import */ var _smithy_protocol_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4094);
/* harmony import */ var _SerdeContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3279);



class HttpProtocol extends _SerdeContext__WEBPACK_IMPORTED_MODULE_4__/* .SerdeContext */ .f {
    options;
    constructor(options) {
        super();
        this.options = options;
    ...
    getRequestType() {
        return _smithy_protocol_http__WEBPACK_IMPORTED_MODULE_2__/* .HttpRequest */ .K;
    }
    getResponseType() {
        return _smithy_protocol_http__WEBPACK_IMPORTED_MODULE_3__/* .HttpResponse */ .c;
    }
    setSerdeContext(serdeContext) {
        this.serdeContext = serdeContext;
        this.serializer.setSerdeContext(serdeContext);
    ...
    setHostPrefix(request, operationSchema, input) {
        const inputNs = _smithy_core_schema__WEBPACK_IMPORTED_MODULE_0__/* .NormalizedSchema */ .l.of(operationSchema.input);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 9779));
...
;// external "process"
const external_process_namespaceObject = __WEBPACK_EXTERNAL_createRequire_require("process");
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(ResourceNotFoundException$, ResourceNotFoundException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(TooManyRequestsException$, TooManyRequestsException);
var UnauthorizedException$ = [-3, n0, _UE,
    { [_e]: _c, [_hE]: 401 },
    [_m],
    [0]
];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(UnauthorizedException$, UnauthorizedException);
var __Unit = "unit";
var SSOServiceException$ = [-3, _s, "SSOServiceException", 0, [], []];
TypeRegistry/* TypeRegistry */.O.for(_s).registerError(SSOServiceException$, SSOServiceException);
...
const package_namespaceObject = {"rE":"3.958.0"};
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/client/emitWarningIfUnsupportedVersion.js
var emitWarningIfUnsupportedVersion = __webpack_require__(5122);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/NODE_AUTH_SCHEME_PREFERENCE_OPTIONS.js + 2 modules
var NODE_AUTH_SCHEME_PREFERENCE_OPTIONS = __webpack_require__(4472);
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 9779));
...
const external_node_crypto_namespaceObject = __WEBPACK_EXTERNAL_createRequire_require("node:crypto");
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 9413));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   l: () => (/* binding */ NormalizedSchema)
/* harmony export */ });
/* unused harmony export isStaticSchema */
...
const promises_namespaceObject = __WEBPACK_EXTERNAL_createRequire_require("node:fs/promises");
...
class JsonShapeSerializer extends ConfigurableSerdeContext/* SerdeContextConfig */.B {
    ...
    write(schema, value) {
        this.rootSchema = NormalizedSchema/* NormalizedSchema */.l.of(schema);
        this.buffer = this._write(this.rootSchema, value);
    }
    writeDiscriminatedDocument(schema, value) {
        this.write(schema, value);
        if (typeof this.buffer === "object") {
            this.buffer.__type = NormalizedSchema/* NormalizedSchema */.l.of(schema).getName(true);
        }
    }
    flush() {
...
class AwsRestJsonProtocol extends HttpBindingProtocol {
    ...
    async serializeRequest(operationSchema, input, context) {
        const request = await super.serializeRequest(operationSchema, input, context);
        const inputSchema = NormalizedSchema/* NormalizedSchema */.l.of(operationSchema.input);
    ...
    async deserializeResponse(operationSchema, context, response) {
        ...
        const outputSchema = NormalizedSchema/* NormalizedSchema */.l.of(operationSchema.output);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(TooManyRequestsError$, TooManyRequestsError);
var ValidationException$ = [-3, n0, _VE, { [_e]: _c, [_hE]: 400 }, [_e, _m], [0, 0]];
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(ValidationException$, ValidationException);
var SigninServiceException$ = [-3, _sm, "SigninServiceException", 0, [], []];
TypeRegistry/* TypeRegistry */.O.for(_sm).registerError(SigninServiceException$, SigninServiceException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(IDPCommunicationErrorException$, IDPCommunicationErrorException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(IDPRejectedClaimException$, IDPRejectedClaimException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidIdentityTokenException$, InvalidIdentityTokenException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(MalformedPolicyDocumentException$, MalformedPolicyDocumentException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(PackedPolicyTooLargeException$, PackedPolicyTooLargeException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(RegionDisabledException$, RegionDisabledException);
var Tag$ = [3, n0, _Ta, 0, [_K, _V], [0, 0]];
var STSServiceException$ = [-3, _s, "STSServiceException", 0, [], []];
TypeRegistry/* TypeRegistry */.O.for(_s).registerError(STSServiceException$, STSServiceException);
...
var AwsQueryProtocol = __webpack_require__(5640);
// EXTERNAL MODULE: ./node_modules/@smithy/smithy-client/dist-es/NoOpLogger.js
var NoOpLogger = __webpack_require__(4098);
// EXTERNAL MODULE: ./node_modules/@smithy/url-parser/dist-es/index.js + 1 modules
var url_parser_dist_es = __webpack_require__(2641);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(ExpiredTradeInTokenException$, ExpiredTradeInTokenException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(InvalidAuthorizationMessageException$, InvalidAuthorizationMessageException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(JWTPayloadSizeExceededException$, JWTPayloadSizeExceededException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(OutboundWebIdentityFederationDisabledException$, OutboundWebIdentityFederationDisabledException);
...
TypeRegistry/* TypeRegistry */.O.for(n0).registerError(SessionDurationEscalationException$, SessionDurationEscalationException);
var Tag$ = [3, n0, _Ta,
    0,
    [_K, _V],
    [0, 0]
