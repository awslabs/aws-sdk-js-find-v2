...
1006(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  S: () => (AwsSdkSigV4ASigner)
});
/* import */ var _smithy_protocol_http__rspack_import_1 = __webpack_require__(7324);
/* import */ var _utils__rspack_import_2 = __webpack_require__(369);
/* import */ var _AwsSdkSigV4Signer__rspack_import_0 = __webpack_require__(5719);



class AwsSdkSigV4ASigner extends _AwsSdkSigV4Signer__rspack_import_0/* .AwsSdkSigV4Signer */.f2 {
    async sign(httpRequest, identity, signingProperties) {
        if (!_smithy_protocol_http__rspack_import_1/* .HttpRequest.isInstance */.K.isInstance(httpRequest)) {
            throw new Error("The request is not an instance of `HttpRequest` and cannot be signed");
        }
        const { config, signer, signingRegion, signingRegionSet, signingName } = await (0,_AwsSdkSigV4Signer__rspack_import_0/* .validateSigningProperties */.pz)(signingProperties);
        const configResolvedSigningRegionSet = await config.sigv4aSigningRegionSet?.();
        const multiRegionOverride = (configResolvedSigningRegionSet ??
            signingRegionSet ?? [signingRegion]).join(",");
        const signedRequest = await signer.sign(httpRequest, {
            signingDate: (0,_utils__rspack_import_2/* .getSkewCorrectedDate */.C)(config.systemClockOffset),
...
5719(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  f2: () => (/* binding */ AwsSdkSigV4Signer),
  pz: () => (/* binding */ validateSigningProperties)
});
...
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/utils/getSkewCorrectedDate.js
var getSkewCorrectedDate = __webpack_require__(369);
...
const isClockSkewed = (clockTime, systemClockOffset) => Math.abs((0,getSkewCorrectedDate/* .getSkewCorrectedDate */.C)(systemClockOffset).getTime() - clockTime) >= 300000;
...
class AwsSdkSigV4Signer {
    async sign(httpRequest, identity, signingProperties) {
        ...
        const signedRequest = await signer.sign(httpRequest, {
            signingDate: (0,getSkewCorrectedDate/* .getSkewCorrectedDate */.C)(config.systemClockOffset),
...
3854(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
1942(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  A: () => (NODE_SIGV4A_CONFIG_OPTIONS),
  O: () => (resolveAwsSdkSigV4AConfig)
});
/* import */ var _smithy_core__rspack_import_0 = __webpack_require__(4367);
/* import */ var _smithy_property_provider__rspack_import_1 = __webpack_require__(6014);


const resolveAwsSdkSigV4AConfig = (config) => {
    config.sigv4aSigningRegionSet = (0,_smithy_core__rspack_import_0/* .normalizeProvider */.t)(config.sigv4aSigningRegionSet);
    return config;
};
const NODE_SIGV4A_CONFIG_OPTIONS = {
    environmentVariableSelector(env) {
        ...
        throw new _smithy_property_provider__rspack_import_1/* .ProviderError */.m("AWS_SIGV4A_SIGNING_REGION_SET not set in env.", {
            tryNextLink: true,
        });
    },
    configFileSelector(profile) {
        ...
        throw new _smithy_property_provider__rspack_import_1/* .ProviderError */.m("sigv4a_signing_region_set not set in profile.", {
            tryNextLink: true,
        });
    },
    default: undefined,
...
// EXTERNAL MODULE: ./node_modules/@smithy/signature-v4/dist-es/SignatureV4.js + 11 modules
var SignatureV4 = __webpack_require__(1815);
...
const resolveAwsSdkSigV4Config = (config) => {
    ...
    if (config.signer) {
        ...
        signer = () => (0,normalizeProvider/* .normalizeProvider */.t)(config.region)()
            ...
            const SignerCtor = config.signerConstructor || SignatureV4/* .SignatureV4 */.B;
...
369(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
...
class ProtocolLib {
    ...
    compose(composite, errorIdentifier, defaultNamespace) {
        ...
        const staticRegistry = _smithy_core_schema__rspack_import_0/* .TypeRegistry["for"] */.O["for"](namespace);
        const defaultSyntheticRegistry = _smithy_core_schema__rspack_import_0/* .TypeRegistry["for"] */.O["for"]("smithy.ts.sdk.synthetic." + defaultNamespace);
    ...
    findQueryCompatibleError(registry, errorName) {
        try {
            ...
            return registry.find((schema) => _smithy_core_schema__rspack_import_2/* .NormalizedSchema.of */.l1.of(schema).getMergedTraits().awsQueryError?.[0] === errorName);
        }
    }
}
...
5140(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
class HttpBindingProtocol extends HttpProtocol/* .HttpProtocol */.t {
    async serializeRequest(operationSchema, _input, context) {
        ...
        const ns = NormalizedSchema/* .NormalizedSchema.of */.l1.of(operationSchema?.input);
    ...
    async deserializeResponse(operationSchema, context, response) {
        ...
        const ns = NormalizedSchema/* .NormalizedSchema.of */.l1.of(operationSchema.output);
        const dataObject = {};
    ...
    async deserializeHttpMessage(schema, context, response, arg4, arg5) {
        ...
        const deserializer = this.deserializer;
        const ns = NormalizedSchema/* .NormalizedSchema.of */.l1.of(schema);
...
var date_utils = __webpack_require__(3694);
...
var v4 = __webpack_require__(1040);
...
var FromStringShapeDeserializer = __webpack_require__(5865);
...
class JsonShapeSerializer extends ConfigurableSerdeContext/* .SerdeContextConfig */.B {
    ...
    write(schema, value) {
        this.rootSchema = NormalizedSchema/* .NormalizedSchema.of */.l1.of(schema);
    ...
    writeDiscriminatedDocument(schema, value) {
        ...
        if (typeof this.buffer === "object") {
            this.buffer.__type = NormalizedSchema/* .NormalizedSchema.of */.l1.of(schema).getName(true);
        }
    }
...
class AwsRestJsonProtocol extends HttpBindingProtocol {
    ...
    async serializeRequest(operationSchema, input, context) {
        ...
        const inputSchema = NormalizedSchema/* .NormalizedSchema.of */.l1.of(operationSchema.input);
    ...
    async deserializeResponse(operationSchema, context, response) {
        ...
        const outputSchema = NormalizedSchema/* .NormalizedSchema.of */.l1.of(operationSchema.output);
    ...
    async handleError(operationSchema, context, response, dataObject, metadata) {
        ...
        const ns = NormalizedSchema/* .NormalizedSchema.of */.l1.of(errorSchema);
...
1364(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
;// CONCATENATED MODULE: ./node_modules/fast-xml-parser/node_modules/path-expression-matcher/src/Matcher.js
...
;// CONCATENATED MODULE: ./node_modules/fast-xml-parser/node_modules/path-expression-matcher/src/Expression.js
/**
...
;// CONCATENATED MODULE: ./node_modules/fast-xml-parser/node_modules/path-expression-matcher/src/ExpressionSet.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/xml-builder/dist-es/xml-external/nodable_entities.js
const nodable_entities_XML = {
    amp: "&",
    apos: "'",
    gt: ">",
    lt: "<",
...
const nodable_entities_COMMON_HTML = {
    nbsp: "\u00a0",
    copy: "\u00a9",
    reg: "\u00ae",
    trade: "\u2122",
...
const nodable_entities_CURRENCY = {
    cent: "\u00a2",
    pound: "\u00a3",
    curren: "\u00a4",
    yen: "\u00a5",
...
const nodable_entities_SPECIAL_CHARS = new Set("!?\\/[]$%{}^&*()<>|+");
function nodable_entities_validateEntityName(name) {
    if (name[0] === "#") {
        throw new Error(`[EntityReplacer] Invalid character '#' in entity name: "${name}"`);
    }
    for (const ch of name) {
        if (nodable_entities_SPECIAL_CHARS.has(ch)) {
            throw new Error(`[EntityReplacer] Invalid character '${ch}' in entity name: "${name}"`);
        }
    }
    return name;
}
function nodable_entities_mergeEntityMaps(...maps) {
    const out = Object.create(null);
    for (const map of maps) {
        if (!map) {
            continue;
...
const nodable_entities_LIMIT_TIER_EXTERNAL = "external";
const nodable_entities_LIMIT_TIER_BASE = "base";
const nodable_entities_LIMIT_TIER_ALL = "all";
function nodable_entities_parseLimitTiers(raw) {
    if (!raw || raw === nodable_entities_LIMIT_TIER_EXTERNAL) {
        return new Set([nodable_entities_LIMIT_TIER_EXTERNAL]);
    }
    if (raw === nodable_entities_LIMIT_TIER_ALL) {
        return new Set([nodable_entities_LIMIT_TIER_ALL]);
    }
    if (raw === nodable_entities_LIMIT_TIER_BASE) {
        return new Set([nodable_entities_LIMIT_TIER_BASE]);
    }
...
const nodable_entities_NCR_LEVEL = Object.freeze({ allow: 0, leave: 1, remove: 2, throw: 3 });
const nodable_entities_XML10_ALLOWED_C0 = new Set([0x09, 0x0a, 0x0d]);
function nodable_entities_parseNCRConfig(ncr) {
    if (!ncr) {
        return { xmlVersion: 1.0, onLevel: nodable_entities_NCR_LEVEL.allow, nullLevel: nodable_entities_NCR_LEVEL.remove };
    }
    const xmlVersion = ncr.xmlVersion === 1.1 ? 1.1 : 1.0;
    const onLevel = nodable_entities_NCR_LEVEL[ncr.onNCR ?? "allow"] ?? nodable_entities_NCR_LEVEL.allow;
    const nullLevel = nodable_entities_NCR_LEVEL[ncr.nullNCR ?? "remove"] ?? nodable_entities_NCR_LEVEL.remove;
    const clampedNull = Math.max(nullLevel, nodable_entities_NCR_LEVEL.remove);
    return { xmlVersion, onLevel, nullLevel: clampedNull };
}
const EntityDecoderImpl = class EntityDecoderImpl {
    ...
    constructor(options = {}) {
        ...
        this._maxExpandedLength = this._limit.maxExpandedLength || 0;
        this._postCheck = typeof options.postCheck === "function" ? options.postCheck : (r) => r;
        this._limitTiers = nodable_entities_parseLimitTiers(this._limit.applyLimitsTo ?? nodable_entities_LIMIT_TIER_EXTERNAL);
        this._numericAllowed = options.numericAllowed ?? true;
        this._baseMap = nodable_entities_mergeEntityMaps(nodable_entities_XML, options.namedEntities || null);
        this._externalMap = Object.create(null);
        this._inputMap = Object.create(null);
        this._totalExpansions = 0;
        this._expandedLength = 0;
        this._removeSet = new Set(options.remove && Array.isArray(options.remove) ? options.remove : []);
        this._leaveSet = new Set(options.leave && Array.isArray(options.leave) ? options.leave : []);
        const ncrCfg = nodable_entities_parseNCRConfig(options.ncr);
        this._ncrXmlVersion = ncrCfg.xmlVersion;
        this._ncrOnLevel = ncrCfg.onLevel;
        this._ncrNullLevel = ncrCfg.nullLevel;
    }
    setExternalEntities(map) {
        if (map) {
            for (const key of Object.keys(map)) {
                nodable_entities_validateEntityName(key);
            }
        }
        this._externalMap = nodable_entities_mergeEntityMaps(map);
    }
    addExternalEntity(key, value) {
        nodable_entities_validateEntityName(key);
        if (typeof value === "string" && value.indexOf("&") === -1) {
    ...
    addInputEntities(map) {
        this._totalExpansions = 0;
        this._expandedLength = 0;
        this._inputMap = nodable_entities_mergeEntityMaps(map);
    }
    reset() {
        this._inputMap = Object.create(null);
        this._totalExpansions = 0;
    ...
    decode(str) {
        ...
        while (i < len) {
            ...
            if (this._removeSet.has(token)) {
                replacement = "";
                if (tier === undefined) {
                    tier = nodable_entities_LIMIT_TIER_EXTERNAL;
                }
            }
            else if (this._leaveSet.has(token)) {
                i++;
                ...
                tier = nodable_entities_LIMIT_TIER_BASE;
            }
            else {
                const resolved = this._resolveName(token);
                replacement = resolved?.value;
    ...
    _tierCounts(tier) {
        if (this._limitTiers.has(nodable_entities_LIMIT_TIER_ALL)) {
            return true;
        }
        return this._limitTiers.has(tier);
    }
    _resolveName(name) {
        if (name in this._inputMap) {
            return { value: this._inputMap[name], tier: nodable_entities_LIMIT_TIER_EXTERNAL };
        }
        if (name in this._externalMap) {
            return { value: this._externalMap[name], tier: nodable_entities_LIMIT_TIER_EXTERNAL };
        }
        if (name in this._baseMap) {
            return { value: this._baseMap[name], tier: nodable_entities_LIMIT_TIER_BASE };
        }
        return undefined;
    }
    _classifyNCR(cp) {
        ...
        if (cp >= 0xd800 && cp <= 0xdfff) {
            return nodable_entities_NCR_LEVEL.remove;
        }
        if (this._ncrXmlVersion === 1.0) {
            if (cp >= 0x01 && cp <= 0x1f && !nodable_entities_XML10_ALLOWED_C0.has(cp)) {
                return nodable_entities_NCR_LEVEL.remove;
            }
        }
        return -1;
    ...
    _applyNCRAction(action, token, cp) {
        switch (action) {
            case nodable_entities_NCR_LEVEL.allow:
                return String.fromCodePoint(cp);
            case nodable_entities_NCR_LEVEL.remove:
                return "";
            case nodable_entities_NCR_LEVEL.leave:
                return undefined;
            case nodable_entities_NCR_LEVEL.throw:
    ...
    _resolveNCR(token) {
        ...
        const minimum = this._classifyNCR(cp);
        if (!this._numericAllowed && minimum < nodable_entities_NCR_LEVEL.remove) {
            return undefined;
        }
...
const entityDecoder = new EntityDecoderImpl({
    namedEntities: { ...nodable_entities_XML, ...nodable_entities_COMMON_HTML, ...nodable_entities_CURRENCY },
    numericAllowed: true,
    limit: {
        maxTotalExpansions: Infinity,
    },
...
class XmlShapeDeserializer extends ConfigurableSerdeContext/* .SerdeContextConfig */.B {
    ...
    readSchema(_schema, value) {
        const ns = NormalizedSchema/* .NormalizedSchema.of */.l1.of(_schema);
        if (ns.isUnitSchema()) {
            return;
        }
        const traits = ns.getMergedTraits();
...
8525(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var node_http_handler = __webpack_require__(934);
...
5291(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var parseKnownFiles = __webpack_require__(5040);
...
const resolveCredentialSource = (credentialSource, profileName, logger) => {
    const sourceProvidersMap = {
        EcsContainer: async (options) => {
            const { fromHttp } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 8525));
            const { fromContainerMetadata } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 8019));
        ...
        Ec2InstanceMetadata: async (options) => {
            ...
            const { fromInstanceMetadata } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 8019));
...
const resolveAssumeRoleCredentials = async (profileName, profiles, options, callerClientConfig, visitedProfiles = {}, resolveProfileData) => {
    ...
    if (!options.roleAssumer) {
        const { getDefaultRoleAssumer } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 5756));
...
class LoginCredentialsFetcher {
    ...
    async refresh(token) {
        const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 6890));
...
const resolveProcessCredentials = async (options, profile) => Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 3995)).then(({ fromProcess }) => fromProcess({
    ...options,
    profile,
...
const resolveSsoCredentials = async (profile, profileData, options = {}, callerClientConfig) => {
    const { fromSSO } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 1489));
    return fromSSO({
        profile,
...
const isWebIdentityProfile = (arg) => Boolean(arg) &&
    ...
    typeof arg.role_arn === "string" &&
    ["undefined", "string"].indexOf(typeof arg.role_session_name) > -1;
const resolveWebIdentityCredentials = async (profile, options, callerClientConfig) => Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 3521)).then(({ fromTokenFile }) => fromTokenFile({
...
3995(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const external_node_util_namespaceObject = __rspack_createRequire_require("node:util");
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/client/setCredentialFeature.js
var setCredentialFeature = __webpack_require__(244);
...
const resolveProcessCredentials = async (profileName, profiles, logger) => {
    ...
    if (profiles[profileName]) {
        ...
        if (credentialProcess !== undefined) {
            const execPromise = (0,external_node_util_namespaceObject.promisify)(externalDataInterceptor/* .externalDataInterceptor */.Z?.getTokenRecord?.().exec ?? external_node_child_process_namespaceObject.exec);
            try {
...
1489(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var getSSOTokenFromFile = __webpack_require__(4415);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 1785));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 1785));
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 312));
    const sso = ssoClient ||
...
312(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var getEndpointPlugin = __webpack_require__(8560);
// EXTERNAL MODULE: ./node_modules/@smithy/smithy-client/dist-es/command.js + 1 modules
var command = __webpack_require__(8103);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/EndpointParameters.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/models/SSOServiceException.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/models/errors.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/schemas/schemas_0.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/commands/GetRoleCredentialsCommand.js
...
var getRecursionDetectionPlugin = __webpack_require__(6326);
...
var getHttpAuthSchemeEndpointRuleSetPlugin = __webpack_require__(6486);
...
var dist_es_configurations = __webpack_require__(6970);
// EXTERNAL MODULE: ./node_modules/@smithy/middleware-retry/dist-es/retryMiddleware.js + 4 modules
var retryMiddleware = __webpack_require__(1443);
...
var resolveAwsSdkSigV4Config = __webpack_require__(923);
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/auth/httpAuthSchemeProvider.js
...
var NODE_AUTH_SCHEME_PREFERENCE_OPTIONS = __webpack_require__(3854);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/util-user-agent-node/dist-es/defaultUserAgent.js + 8 modules
var defaultUserAgent = __webpack_require__(5940);
...
var resolveDefaultsModeConfig = __webpack_require__(2099);
...
var url_parser_dist_es = __webpack_require__(1866);
// EXTERNAL MODULE: ./node_modules/@smithy/util-base64/dist-es/fromBase64.js
var fromBase64 = __webpack_require__(1395);
// EXTERNAL MODULE: ./node_modules/@smithy/util-base64/dist-es/toBase64.js
var toBase64 = __webpack_require__(9718);
...
var util_endpoints_dist_es = __webpack_require__(5400);
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/decideEndpoint.js + 24 modules
var decideEndpoint = __webpack_require__(3802);
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/bdd/BinaryDecisionDiagram.js
var BinaryDecisionDiagram = __webpack_require__(2388);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/bdd.js
...
const bdd = BinaryDecisionDiagram/* .BinaryDecisionDiagram.from */.d.from(nodes, root, _data.conditions, _data.results);

;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/endpoint/endpointResolver.js
...
const defaultEndpointResolver = (endpointParams, context = {}) => {
    return cache.get(endpointParams, () => (0,decideEndpoint/* .decideEndpoint */.c)(bdd, {
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeConfig.shared.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeConfig.js
...
var defaultExtensionConfiguration = __webpack_require__(307);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/auth/httpAuthExtensionConfiguration.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/runtimeExtensions.js
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso/SSOClient.js
...
3521(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 5756));
...
6326(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
5507(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/@aws-sdk/util-endpoints/dist-es/index.js + 15 modules
var dist_es = __webpack_require__(5400);
// EXTERNAL MODULE: ./node_modules/@smithy/protocol-http/dist-es/httpRequest.js
var httpRequest = __webpack_require__(7324);
// EXTERNAL MODULE: ./node_modules/@smithy/util-retry/dist-es/retries-2026-config.js
var retries_2026_config = __webpack_require__(4361);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/client/setFeature.js

retries_2026_config/* .Retry.v2026 */.f.v2026 ||= typeof process === "object" && process.env?.AWS_NEW_RETRIES_2026 === "true";
    ...
    if (typeof config.retryStrategy === "function") {
        ...
        if (typeof retryStrategy.mode === "string") {
            switch (retryStrategy.mode) {
                case dist_es_config/* .RETRY_MODES.ADAPTIVE */.c.ADAPTIVE:
                    setFeature(context, "RETRY_MODE_ADAPTIVE", "F");
                    break;
                case dist_es_config/* .RETRY_MODES.STANDARD */.c.STANDARD:
...
6890(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/bdd/BinaryDecisionDiagram.js
var BinaryDecisionDiagram = __webpack_require__(2388);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/signin/endpoint/bdd.js
...
1785(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/bdd/BinaryDecisionDiagram.js
var BinaryDecisionDiagram = __webpack_require__(2388);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sso-oidc/endpoint/bdd.js
...
5756(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4Config.js + 1 modules
var resolveAwsSdkSigV4Config = __webpack_require__(923);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/resolveAwsSdkSigV4AConfig.js
var resolveAwsSdkSigV4AConfig = __webpack_require__(1942);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/signature-v4-multi-region/dist-es/SignatureV4MultiRegion.js + 4 modules
var SignatureV4MultiRegion = __webpack_require__(583);
// EXTERNAL MODULE: ./node_modules/@smithy/middleware-endpoint/dist-es/adaptors/getEndpointFromInstructions.js + 2 modules
var getEndpointFromInstructions = __webpack_require__(303);
// EXTERNAL MODULE: ./node_modules/@smithy/util-middleware/dist-es/getSmithyContext.js
var getSmithyContext = __webpack_require__(6116);
// EXTERNAL MODULE: ./node_modules/@smithy/util-middleware/dist-es/normalizeProvider.js
var normalizeProvider = __webpack_require__(8947);
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/bdd/BinaryDecisionDiagram.js
var BinaryDecisionDiagram = __webpack_require__(2388);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/nested-clients/dist-es/submodules/sts/endpoint/bdd.js

const q = "ref";
const a = -1, b = true, c = "isSet", d = "PartitionResult", e = "booleanEquals", f = "stringEquals", g = "getAttr", h = "us-east-1", i = "sigv4", j = "sts", k = "https://sts.{Region}.{PartitionResult#dnsSuffix}", l = { [q]: "Endpoint" }, m = { [q]: "Region" }, n = { [q]: d }, bdd_o = {}, p = [m];
const _data = {
    conditions: [
        [c, [l]],
        [c, p],
    ...
    results: [
        ...
        [a, "Invalid Configuration: Dualstack and custom endpoint are not supported"],
        [l, bdd_o],
        ["https://sts-fips.{Region}.{PartitionResult#dualStackDnsSuffix}", bdd_o],
        [a, "FIPS and DualStack are enabled, but this partition does not support one or both"],
        ["https://sts.{Region}.amazonaws.com", bdd_o],
        ["https://sts-fips.{Region}.{PartitionResult#dnsSuffix}", bdd_o],
        [a, "FIPS is enabled but this partition does not support FIPS"],
        ["https://sts.{Region}.{PartitionResult#dualStackDnsSuffix}", bdd_o],
        [a, "DualStack is enabled but this partition does not support DualStack"],
        [k, bdd_o],
        [a, "Invalid Configuration: Missing Region"],
    ],
...
const createEndpointRuleSetHttpAuthSchemeParametersProvider = (defaultHttpAuthSchemeParametersProvider) => async (config, context, input) => {
    ...
    const instructionsFn = (0,getSmithyContext/* .getSmithyContext */.u)(context)?.commandInstance?.constructor
        ?.getEndpointParameterInstructions;
    if (!instructionsFn) {
        throw new Error(`getEndpointParameterInstructions() is not defined on '${context.commandName}'`);
    }
    const endpointParameters = await (0,getEndpointFromInstructions/* .resolveParams */.x)(input, { getEndpointParameterInstructions: instructionsFn }, config);
    ...
    const endpointRuleSetHttpAuthSchemeProvider = (authParameters) => {
        ...
        for (const scheme of authSchemes) {
            ...
            if (name === "sigv4a") {
                ...
                if (SignatureV4MultiRegion/* .SignatureV4MultiRegion.sigv4aDependency */.W.sigv4aDependency() === "none" && sigv4Present) {
                    continue;
                }
            }
...
const defaultSTSHttpAuthSchemeProvider = createEndpointRuleSetHttpAuthSchemeProvider(endpointResolver_defaultEndpointResolver, _defaultSTSHttpAuthSchemeProvider, {
...
const resolveHttpAuthSchemeConfig = (config) => {
    ...
    const config_2 = (0,resolveAwsSdkSigV4AConfig/* .resolveAwsSdkSigV4AConfig */.O)(config_1);
...
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/AwsSdkSigV4Signer.js + 3 modules
var AwsSdkSigV4Signer = __webpack_require__(5719);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/AwsSdkSigV4ASigner.js
var AwsSdkSigV4ASigner = __webpack_require__(1006);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/util-user-agent-node/dist-es/defaultUserAgent.js + 8 modules
var defaultUserAgent = __webpack_require__(5940);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/util-user-agent-node/dist-es/nodeAppIdConfigOptions.js
var nodeAppIdConfigOptions = __webpack_require__(9915);
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-retry/dist-es/config.js
var dist_es_config = __webpack_require__(7355);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/protocols/query/AwsQueryProtocol.js + 21 modules
var AwsQueryProtocol = __webpack_require__(1364);
// EXTERNAL MODULE: ./node_modules/@smithy/smithy-client/dist-es/NoOpLogger.js
var NoOpLogger = __webpack_require__(4098);
// EXTERNAL MODULE: ./node_modules/@smithy/url-parser/dist-es/index.js + 1 modules
var url_parser_dist_es = __webpack_require__(1866);
    ...
    return {
        ...
        httpAuthSchemes: config?.httpAuthSchemes ?? [
            ...
            },
            {
                ...
                signer: new AwsSdkSigV4ASigner/* .AwsSdkSigV4ASigner */.S(),
            },
            {
                schemeId: "smithy.api#noAuth",
                identityProvider: (ipc) => ipc.getIdentityProvider("smithy.api#noAuth") || (async () => ({})),
        ...
        signerConstructor: config?.signerConstructor ?? SignatureV4MultiRegion/* .SignatureV4MultiRegion */.W,
        urlParser: config?.urlParser ?? url_parser_dist_es/* .parseUrl */.D,
        utf8Decoder: config?.utf8Decoder ?? fromUtf8/* .fromUtf8 */.a,
        utf8Encoder: config?.utf8Encoder ?? toUtf8/* .toUtf8 */.P,
    };
...
const runtimeConfig_getRuntimeConfig = (config) => {
    ...
    return {
        ...
        sha256: config?.sha256 ?? hash_node_dist_es/* .Hash.bind */.V.bind(null, "sha256"),
        sigv4aSigningRegionSet: config?.sigv4aSigningRegionSet ?? (0,configLoader/* .loadConfig */.Z)(resolveAwsSdkSigV4AConfig/* .NODE_SIGV4A_CONFIG_OPTIONS */.A, loaderConfig),
        streamCollector: config?.streamCollector ?? stream_collector/* .streamCollector */.k,
        useDualstackEndpoint: config?.useDualstackEndpoint ?? (0,configLoader/* .loadConfig */.Z)(NodeUseDualstackEndpointConfigOptions/* .NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS */.e$, loaderConfig),
        useFipsEndpoint: config?.useFipsEndpoint ?? (0,configLoader/* .loadConfig */.Z)(NodeUseFipsEndpointConfigOptions/* .NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS */.Ko, loaderConfig),
        userAgentAppId: config?.userAgentAppId ?? (0,configLoader/* .loadConfig */.Z)(nodeAppIdConfigOptions/* .NODE_APP_ID_CONFIG_OPTIONS */.hV, loaderConfig),
...
583(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  W: () => (/* binding */ SignatureV4MultiRegion)
});

// EXTERNAL MODULE: ./node_modules/@smithy/signature-v4/dist-es/SignatureV4.js + 11 modules
var SignatureV4 = __webpack_require__(1815);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/middleware-sdk-s3/dist-es/s3-express/constants.js
...
const NODE_DISABLE_S3_EXPRESS_SESSION_AUTH_OPTIONS = (/* unused pure expression or super */ null && ({
...
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/middleware-sdk-s3/dist-es/s3-express/classes/SignatureV4S3Express.js


class SignatureV4S3Express extends SignatureV4/* .SignatureV4 */.B {
...
;// CONCATENATED MODULE: ./node_modules/@smithy/signature-v4/dist-es/signature-v4a-container.js
const signatureV4aContainer = {
    SignatureV4a: null,
};

;// CONCATENATED MODULE: ./node_modules/@aws-sdk/signature-v4-multi-region/dist-es/signature-v4-crt-container.js
const signatureV4CrtContainer = {
    CrtSignerV4: null,
};

;// CONCATENATED MODULE: ./node_modules/@aws-sdk/signature-v4-multi-region/dist-es/SignatureV4MultiRegion.js
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-config-provider/dist-es/booleanSelector.js
var booleanSelector = __webpack_require__(5938);
// EXTERNAL MODULE: ./node_modules/@smithy/util-config-provider/dist-es/types.js
var types = __webpack_require__(3466);
// EXTERNAL MODULE: external "node:fs/promises"
var promises_ = __webpack_require__(1455);
// EXTERNAL MODULE: external "node:path"
var external_node_path_ = __webpack_require__(6760);
...
const getNodeModulesParentDirs = (dirname) => {
    ...
    const parentDir = nodeModulesIndex !== -1 ? parts.slice(0, nodeModulesIndex).join(external_node_path_.sep) : normalizedPath;
    if (cwd === parentDir) {
        return [cwd];
    }
...
let tscVersion;
const TS_PACKAGE_JSON = (0,external_node_path_.join)("node_modules", "typescript", "package.json");
const getTypeScriptUserAgentPair = async () => {
    ...
    try {
        isTypeScriptDetectionDisabled =
            (0,booleanSelector/* .booleanSelector */.Q)(process.env, "AWS_SDK_JS_TYPESCRIPT_DETECTION_DISABLED", types/* .SelectorType.ENV */.c.ENV) || false;
    }
    catch { }
    ...
    for (const nodeModulesParentDir of nodeModulesParentDirs) {
        try {
            const appPackageJsonPath = (0,external_node_path_.join)(nodeModulesParentDir, "package.json");
            const packageJson = await (0,promises_.readFile)(appPackageJsonPath, "utf-8");
    ...
    for (const nodeModulesParentDir of nodeModulesParentDirs) {
        try {
            const tsPackageJsonPath = (0,external_node_path_.join)(nodeModulesParentDir, TS_PACKAGE_JSON);
            const packageJson = await (0,promises_.readFile)(tsPackageJsonPath, "utf-8");
...
const nodeDualstackConfigSelectors = (/* unused pure expression or super */ null && ({
...
const nodeFipsConfigSelectors = (/* unused pure expression or super */ null && ({
...
6486(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
7300(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
7311(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
class HttpProtocol extends _SerdeContext__rspack_import_0/* .SerdeContext */.f {
    ...
    setHostPrefix(request, operationSchema, input) {
        ...
        const inputNs = _smithy_core_schema__rspack_import_4/* .NormalizedSchema.of */.l1.of(operationSchema.input);
    ...
    async loadEventStreamCapability() {
        const { EventStreamSerde } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 7311));
...
5790(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
5865(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
7806(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: deserializerMiddlewareOption, serializerMiddlewareOption
...
// EXTERNAL MODULE: ./node_modules/@smithy/url-parser/dist-es/index.js + 1 modules
var dist_es = __webpack_require__(1866);
;// CONCATENATED MODULE: ./node_modules/@smithy/core/dist-es/submodules/endpoints/toEndpointV1.js

const toEndpointV1 = (endpoint) => {
    if (typeof endpoint === "object") {
        if ("url" in endpoint) {
            const v1Endpoint = (0,dist_es/* .parseUrl */.D)(endpoint.url);
            if (endpoint.headers) {
                v1Endpoint.headers = {};
                for (const name in endpoint.headers) {
    ...
    return (0,dist_es/* .parseUrl */.D)(endpoint);
};
...
3694(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
8019(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const external_http_namespaceObject = __rspack_createRequire_require("http");
...
838(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
303(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  r: () => (/* binding */ getEndpointFromInstructions),
  x: () => (/* binding */ resolveParams)
});
...
var getEndpointFromConfig = __webpack_require__(838);
...
/* import */ var _smithy_url_parser__rspack_import_0 = __webpack_require__(1866);

const toEndpointV1 = (endpoint) => {
    if (typeof endpoint === "object") {
        if ("url" in endpoint) {
            const v1Endpoint = (0,_smithy_url_parser__rspack_import_0/* .parseUrl */.D)(endpoint.url);
            if (endpoint.headers) {
                v1Endpoint.headers = {};
...
8560(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const endpointMiddleware = ({ config, instructions, }) => {
    return (next, context) => async (args) => {
        ...
        const endpoint = await (0,getEndpointFromInstructions/* .getEndpointFromInstructions */.r)(args.input, {
            getEndpointParameterInstructions() {
                return instructions;
            },
        }, { ...config }, context);
...
/* import */ var _adaptors_getEndpointFromConfig__rspack_import_2 = __webpack_require__(838);
...
6970(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var dist_es = __webpack_require__(6992);
...
class DefaultRateLimiter {
    ...
    updateClientSendingRate(response) {
        ...
        const isThrottling = retryErrorInfo?.errorType === "THROTTLING" || (0,dist_es/* .isThrottlingError */.Qb)(retryErrorInfo?.error ?? response);
        if (isThrottling) {
...
class DefaultRetryBackoffStrategy {
    x = retries_2026_config/* .Retry.delay */.f.delay();
    computeNextBackoffDelay(i) {
        const b = Math.random();
        const r = 2;
        const t_i = b * Math.min(this.x * r ** i, (/* inlined export .MAXIMUM_RETRY_DELAY */20000));
...
class DefaultRetryToken {
    ...
    getRetryDelay() {
        return Math.min((/* inlined export .MAXIMUM_RETRY_DELAY */20000), this.delay);
    }
    getRetryCost() {
        return this.cost;
    }
...
class StandardRetryStrategy {
    ...
    constructor(arg1) {
        ...
        this.maxAttemptsProvider ??= async () => (/* inlined export .DEFAULT_MAX_ATTEMPTS */3);
        this.baseDelay ??= retries_2026_config/* .Retry.delay */.f.delay();
        this.retryBackoffStrategy ??= new DefaultRetryBackoffStrategy();
    }
    async acquireInitialRetryToken(retryTokenScope) {
        return new DefaultRetryToken(retries_2026_config/* .Retry.delay */.f.delay(), 0, undefined, retries_2026_config/* .Retry.v2026 */.f.v2026 && retryTokenScope.includes(":longpoll"));
    }
    async refreshRetryTokenForRetry(token, errorInfo) {
        ...
        if (shouldRetry || isLongPoll) {
            ...
            this.retryBackoffStrategy.setDelayBase(errorType === "THROTTLING" ? retries_2026_config/* .Retry.throttlingDelay */.f.throttlingDelay() : this.baseDelay);
            ...
            if (!shouldRetry) {
                throw Object.assign(new Error("No retry token available"), {
                    $backoff: retries_2026_config/* .Retry.v2026 */.f.v2026 && retryCode === refusal.capacity && isLongPoll ? retryDelay : 0,
                });
            }
            else {
    ...
    recordSuccess(token) {
        this.capacity = Math.min((/* inlined export .INITIAL_RETRY_TOKENS */500), this.capacity + (token.getRetryCost() ?? (/* inlined export .NO_RETRY_INCREMENT */1)));
    }
    getCapacity() {
    ...
    getCapacityCost(errorType) {
        return errorType === retries_2026_config/* .Retry.modifiedCostType */.f.modifiedCostType() ? retries_2026_config/* .Retry.throttlingCost */.f.throttlingCost() : retries_2026_config/* .Retry.cost */.f.cost();
    }
...
const resolveRetryConfig = (input) => {
    ...
    const maxAttempts = (0,normalizeProvider/* .normalizeProvider */.t)(input.maxAttempts ?? (/* inlined export .DEFAULT_MAX_ATTEMPTS */3));
    let controller = retryStrategy
        ? Promise.resolve(retryStrategy)
        : undefined;
    const getDefault = async () => (await (0,normalizeProvider/* .normalizeProvider */.t)(retryMode)()) === config/* .RETRY_MODES.ADAPTIVE */.c.ADAPTIVE
...
1443(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: retryMiddleware, retryMiddlewareOptions
...
// EXTERNAL MODULE: ./node_modules/@smithy/protocol-http/dist-es/httpResponse.js
var httpResponse = __webpack_require__(4094);
;// CONCATENATED MODULE: ./node_modules/@smithy/middleware-retry/dist-es/parseRetryAfterHeader.js
    ...
    for (const header of Object.keys(response.headers)) {
        ...
        if (h === "retry-after") {
            ...
            if (retryAfter.endsWith("GMT")) {
                try {
                    const date = (0,date_utils/* .parseRfc7231DateTime */.xE)(retryAfter);
...
7073(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var loadSharedConfigFiles = __webpack_require__(259);
...
934(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const external_node_https_namespaceObject = __rspack_createRequire_require("node:https");
;// CONCATENATED MODULE: ./node_modules/@smithy/node-http-handler/dist-es/build-abort-error.js
...
function writeBody(httpRequest, body) {
    if (body instanceof external_node_stream_.Readable) {
    ...
    async handle(request, { abortSignal, requestTimeout } = {}) {
        ...
        return new Promise((_resolve, _reject) => {
            ...
            if (expectContinue && !this.externalAgent) {
                agent = new (isSSL ? external_node_https_namespaceObject.Agent : hAgent)({
                    keepAlive: false,
                    maxSockets: Infinity,
                });
            }
            ...
            const requestFunc = isSSL ? external_node_https_namespaceObject.request : hRequest;
    ...
    resolveDefaultConfig(options) {
        ...
        return {
            ...
            httpAgentProvider: async () => {
                const { Agent, request } = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 7067, 23));
                hRequest = request;
                hAgent = Agent;
            ...
            httpsAgent: (() => {
                if (httpsAgent instanceof external_node_https_namespaceObject.Agent || typeof httpsAgent?.destroy === "function") {
                    this.externalAgent = true;
                    return httpsAgent;
                }
                return new external_node_https_namespaceObject.Agent({ keepAlive, maxSockets, ...httpsAgent });
            })(),
            logger,
        };
    }
...
3439(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
class Collector extends external_node_stream_.Writable {
    bufferedBytes = [];
...
6992(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// UNUSED EXPORTS: isBrowserNetworkError, isClockSkewCorrectedError, isClockSkewError, isNodeJsHttp2TransientError, isRetryableByTrait
...
/* import */ var _getSSOTokenFromFile__rspack_import_1 = __webpack_require__(4415);
/* import */ var _readFile__rspack_import_0 = __webpack_require__(733);
...
/* import */ var _getHomeDir__rspack_import_1 = __webpack_require__(4350);
...
4350(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* import */ var _getHomeDir__rspack_import_2 = __webpack_require__(4350);
...
4415(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const promises_namespaceObject = __rspack_createRequire_require("fs/promises");
// EXTERNAL MODULE: ./node_modules/@smithy/shared-ini-file-loader/dist-es/getSSOTokenFilepath.js
var getSSOTokenFilepath = __webpack_require__(2594);
...
const getSSOTokenFromFile = async (id) => {
    ...
    const ssoTokenText = await (0,promises_namespaceObject.readFile)(ssoTokenFilepath, "utf8");
    return JSON.parse(ssoTokenText);
};


},
259(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
var getHomeDir = __webpack_require__(4350);
...
5040(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
/* import */ var node_fs_promises__rspack_import_0 = __webpack_require__(1455);
/* import */ var node_fs_promises__rspack_import_0_default = /*#__PURE__*/__webpack_require__.n(node_fs_promises__rspack_import_0);
...
const readFile = (path, options) => {
    ...
    if (!filePromises[path] || options?.ignoreCache) {
        filePromises[path] = (0,node_fs_promises__rspack_import_0.readFile)(path, "utf8");
    }
...
1815(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  B: () => (/* binding */ SignatureV4)
});
...
class SignatureV4Base {
    ...
    constructor({ applyChecksum, credentials, region, service, sha256, uriEscapePath = true, }) {
        ...
        this.regionProvider = (0,normalizeProvider/* .normalizeProvider */.t)(region);
        this.credentialProvider = (0,normalizeProvider/* .normalizeProvider */.t)(credentials);
    }
...
8103(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
307(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const knownAlgorithms = Object.values(checksum_AlgorithmId);
...
1866(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
2099(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
const inferPhysicalRegion = async () => {
    ...
    if (!process.env[ENV_IMDS_DISABLED]) {
        try {
            const { getInstanceMetadataEndpoint, httpRequest } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 8019));
            const endpoint = await getInstanceMetadataEndpoint();
...
2388(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  d: () => (BinaryDecisionDiagram)
});
...
3802(__unused_rspack_module, __webpack_exports__, __webpack_require__) {

// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  c: () => (/* binding */ decideEndpoint)
});
...
;// CONCATENATED MODULE: ./node_modules/@smithy/util-endpoints/dist-es/lib/coalesce.js
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/lib/isValidHostLabel.js
var isValidHostLabel = __webpack_require__(8883);
;// CONCATENATED MODULE: ./node_modules/@smithy/util-endpoints/dist-es/lib/ite.js
...
;// CONCATENATED MODULE: ./node_modules/@smithy/util-endpoints/dist-es/lib/split.js
...
const callFunction = ({ fn, argv }, options) => {
    ...
    if (namespaceSeparatorIndex !== -1) {
        const namespaceFunctions = customEndpointFunctions/* .customEndpointFunctions */.m[fn.slice(0, namespaceSeparatorIndex)];
...
const getEndpointProperties = (properties, options) => Object.entries(properties).reduce((acc, [propertyKey, propertyVal]) => {
    acc[propertyKey] = getEndpointProperties_group.getEndpointProperty(propertyVal, options);
    return acc;
}, {});
...
;// CONCATENATED MODULE: ./node_modules/@smithy/util-endpoints/dist-es/decideEndpoint.js
...
4361(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
__webpack_require__.d(__webpack_exports__, {
  f: () => (Retry)
});
class Retry {
...
3207(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
1040(__unused_rspack_module, __webpack_exports__, __webpack_require__) {
...
// EXTERNAL MODULE: ./node_modules/@smithy/util-endpoints/dist-es/bdd/BinaryDecisionDiagram.js
var BinaryDecisionDiagram = __webpack_require__(2388);
;// CONCATENATED MODULE: ./node_modules/@aws-sdk/client-sts/dist-es/endpoint/bdd.js

const q = "ref";
const a = -1, b = true, bdd_c = "isSet", d = "PartitionResult", e = "booleanEquals", f = "stringEquals", g = "getAttr", h = "us-east-1", i = "sigv4", j = "sts", k = "https://sts.{Region}.{PartitionResult#dnsSuffix}", l = { [q]: "Endpoint" }, m = { [q]: "Region" }, n = { [q]: d }, bdd_o = {}, p = [m];
const _data = {
    conditions: [
        [bdd_c, [l]],
        [bdd_c, p],
...
var package_namespaceObject = {"rE":"3.1040.0"}
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/client/emitWarningIfUnsupportedVersion.js
var emitWarningIfUnsupportedVersion = __webpack_require__(5122);
// EXTERNAL MODULE: ./node_modules/@aws-sdk/core/dist-es/submodules/httpAuthSchemes/aws_sdk/NODE_AUTH_SCHEME_PREFERENCE_OPTIONS.js + 2 modules
var NODE_AUTH_SCHEME_PREFERENCE_OPTIONS = __webpack_require__(3854);
...
const remoteProvider = async (init) => {
    const { ENV_CMDS_FULL_URI, ENV_CMDS_RELATIVE_URI, fromContainerMetadata, fromInstanceMetadata } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 8019));
...
`);
    ...
    async (awsIdentityProperties) => {
        ...
        const { fromIni } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 5291));
        return fromIni(init)(awsIdentityProperties);
    },
    async (awsIdentityProperties) => {
        init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromProcess");
        const { fromProcess } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 3995));
        return fromProcess(init)(awsIdentityProperties);
    },
    async (awsIdentityProperties) => {
        init.logger?.debug("@aws-sdk/credential-provider-node - defaultProvider::fromTokenFile");
        const { fromTokenFile } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 3521));
