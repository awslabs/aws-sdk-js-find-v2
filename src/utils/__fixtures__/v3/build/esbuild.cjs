...
var GetCallerIdentityCommand = class extends Command.classBuilder().ep(commonParams).m(function(Command2, cs, config, o2) {
...
var handler = async () => client.send(new GetCallerIdentityCommand());
